  ...
  <div class="wrapper relative group border-black">
    <div class="absolute top-3 sm:top-4 left-5">
      <div class="relative">
        ...
        <SolidCircleIcon @click="makeItComplete" class="h-100 w-100 absolute left-0 top-0 text-green-500" />
      </div>
    </div>
    ...
    <form @submit.prevent>
      ...
      <input v-model="newTask.tarea" v-bind:class="theme.isDark === true ? 'dark' : '' " type="text" placeholder="Escribe una nueva tarea"
